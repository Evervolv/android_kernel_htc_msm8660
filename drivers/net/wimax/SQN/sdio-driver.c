...
char	*bootrom_name	= SQN_DEFAULT_BOOTROM_NAME;
char	*firmware_name_recovery	= SQN_DEFAULT_FW_NAME_RECOVERY;
#endif
/**
...
#ifdef SQN_UNIQUE_FIRMWARE
module_param(bootrom_name, charp, S_IRUGO);
MODULE_PARM_DESC(bootrom_name, "name of bootrom binary");
#endif
